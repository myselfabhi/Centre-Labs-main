  ...
  return (
    <div className="space-y-6">
      <div className="grid md:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-xl border p-4"><div className="text-xs text-muted-foreground">Top post (range)</div><div className="text-sm font-semibold truncate">{topPages[0]?.title || '—'}</div></div>
      </div>
