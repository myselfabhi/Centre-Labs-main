      ...
      <DashboardLayout>
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold tracking-tight">Tier 1 Customers</h1>
              <p className="text-muted-foreground">
                Manage your Tier 1 (Consumer) customers
              </p>
            </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Search and filter Tier 1 customers</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Tier 1 Customers List</CardTitle>
              <CardDescription>
                {loading ? 'Loading...' : `Showing ${customers.length} of ${totalCustomers} Tier 1 customers`}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <CustomersTable
