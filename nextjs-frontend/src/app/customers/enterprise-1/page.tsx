      ...
      <DashboardLayout>
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold tracking-tight">Enterprise 1 Customers</h1>
              <p className="text-muted-foreground">
                Manage your Enterprise 1 customers
              </p>
            </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Search and filter Enterprise 1 customers</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Enterprise 1 Customers List</CardTitle>
              <CardDescription>
                {loading ? 'Loading...' : `Showing ${customers.length} of ${totalCustomers} Enterprise 1 customers`}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <CustomersTable
