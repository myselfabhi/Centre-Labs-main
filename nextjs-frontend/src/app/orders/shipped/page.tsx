      ...
      <DashboardLayout>
        <div className="space-y-3 sm:space-y-6 px-2 sm:px-0">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold tracking-tight">Shipped Orders</h1>
              <p className="text-muted-foreground text-xs sm:text-sm lg:text-base">
                Manage all shipped orders
              </p>
            </div>
          ...
          <Card className="overflow-hidden">
            <CardHeader className="px-3 sm:px-6">
              ...
              <CardDescription>Search and filter shipped orders</CardDescription>
            </CardHeader>
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:gap-4">
                  ...
                  {/* <Select value={statusFilter} onValueChange={handleStatusFilter}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="CANCELLED">Cancelled</SelectItem>                    </SelectContent>
                  </Select> */}
          ...
          <Card>
            <CardHeader className="px-3 sm:px-6">
              <CardTitle className="text-lg sm:text-xl">Shipped Orders</CardTitle>
            </CardHeader>
            <CardContent className="px-3 sm:px-6">
